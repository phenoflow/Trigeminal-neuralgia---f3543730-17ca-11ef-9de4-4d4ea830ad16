...
(async () => {
  ...
  await fs.writeFile("trigeminal-neuralgia-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("trigeminal-neuralgia-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
